...
- How to write industry standard code
- How to properly use git and version control

## Attribution

This project is heavily inspired by Zod. A very well known and widely used validation library in the TypeScript ecosystem.
